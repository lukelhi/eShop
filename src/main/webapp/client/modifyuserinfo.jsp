...
<%@ taglib prefix="p" uri="http://lhi.login-tags" %>
				...
				<td width="25%">
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd">
								<img src="${pageContext.request.contextPath }/client/images/miniicon.gif" width="9" height="6" />&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath}/client/order/findOrderByUser">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd">
							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><input type="password" name="password" id="password" class="textinput" onkeyup="checkPassword();"/></td>
								...
								<p style="text-align:center">
									<input type="submit" src="${pageContext.request.contextPath }/client/images/botton_gif_025.gif"/>
<%--									<a href="success.html">--%>
