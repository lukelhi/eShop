														...
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username" value="${cookie.eShop_username.value}"
																		type="text" class="textinput" />
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input name="password" value="${cookie.eShop_password.value}"
